...
int main( int ac, char **av )
{
	...
	FragTrap firstFrag("Poulet Frag");
	FragTrap* secondFrag = new FragTrap;

	firstFrag.attack(secondFrag->getName());
	secondFrag->takeDamage(firstFrag.getAttDamage());
	secondFrag->beRepaired(5);
	firstFrag.printStats();
	secondFrag->printStats();
